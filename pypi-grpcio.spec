...
Source0  : https://files.pythonhosted.org/packages/50/4e/7ed8c24c93c8d000b9ea2927f555ae3b03cfabe035d65eda0db848cb20b6/grpcio-1.62.0.tar.gz
...
%prep
%setup -q -n grpcio-1.62.0
cd %{_builddir}/grpcio-1.62.0
pushd ..
cp -a grpcio-1.62.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708616234

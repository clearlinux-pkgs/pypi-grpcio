...
Source0  : https://files.pythonhosted.org/packages/c4/8a/61f84aa2f061395a1aa9faaf325fa200da44191c9631082f33d46602efff/grpcio-1.51.1.tar.gz
...
%prep
%setup -q -n grpcio-1.51.1
cd %{_builddir}/grpcio-1.51.1
pushd ..
cp -a grpcio-1.51.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669821655

...
Source0  : https://files.pythonhosted.org/packages/69/e1/4b21b5017c33f3600dcc32b802bb48fe44a4d36d6c066f52650c7c2690fa/grpcio-1.70.0.tar.gz
...
%prep
%setup -q -n grpcio-1.70.0
cd %{_builddir}/grpcio-1.70.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737754046

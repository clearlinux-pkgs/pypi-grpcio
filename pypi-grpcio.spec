...
Source0  : https://files.pythonhosted.org/packages/65/75/8b706e1170e2c7b6242b1675259e47986bb4fc490f29387989a965972e6e/grpcio-1.44.0.tar.gz
...
%prep
%setup -q -n grpcio-1.44.0
cd %{_builddir}/grpcio-1.44.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645213071
...
cp %{_builddir}/grpcio-1.44.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-grpcio/34ac89724cb7e3fb36bcfe93efabfd012c569a0e

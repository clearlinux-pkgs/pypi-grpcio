...
Source0  : https://files.pythonhosted.org/packages/04/7a/cb869ec6d7f634c0153b4a38ae25bb33699b9307ea17f8cb22b609a46605/grpcio-1.62.2.tar.gz
...
%prep
%setup -q -n grpcio-1.62.2
cd %{_builddir}/grpcio-1.62.2
pushd ..
cp -a grpcio-1.62.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713538164

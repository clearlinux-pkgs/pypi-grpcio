...
Source0  : https://files.pythonhosted.org/packages/c7/bb/d01494037edee2d8e024cac8049b169b2723186b01cebb495ccf677bbba9/grpcio-1.62.1.tar.gz
...
%prep
%setup -q -n grpcio-1.62.1
cd %{_builddir}/grpcio-1.62.1
pushd ..
cp -a grpcio-1.62.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710171654

...
Source0  : https://files.pythonhosted.org/packages/1c/95/aa11fc09a85d91fbc7dd405dcb2a1e0256989d67bf89fa65ae24b3ba105a/grpcio-1.71.0.tar.gz
...
%prep
%setup -q -n grpcio-1.71.0
cd %{_builddir}/grpcio-1.71.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741783061

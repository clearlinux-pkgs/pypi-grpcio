...
Source0  : https://files.pythonhosted.org/packages/79/e8/b43b851537da2e2f03fa8be1aef207e5cbfb1a2e014fbb6b40d24c177cd3/grpcio-1.73.1.tar.gz
...
%prep
%setup -q -n grpcio-1.73.1
cd %{_builddir}/grpcio-1.73.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750961801

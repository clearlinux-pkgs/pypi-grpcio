...
Source0  : https://files.pythonhosted.org/packages/d9/59/bdfe3fc167366e064392367083e705f2b63aeda2b7c004055e7ec80ef538/grpcio-1.65.1.tar.gz
...
%prep
%setup -q -n grpcio-1.65.1
cd %{_builddir}/grpcio-1.65.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721321096

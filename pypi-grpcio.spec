...
Source0  : https://files.pythonhosted.org/packages/f9/d1/8e1d6f684e36492476e1d6bbbf0162f8021421d9880fc346620d29f3c5a6/grpcio-1.51.3.tar.gz
...
%prep
%setup -q -n grpcio-1.51.3
cd %{_builddir}/grpcio-1.51.3
pushd ..
cp -a grpcio-1.51.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677081822

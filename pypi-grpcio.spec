...
Source0  : https://files.pythonhosted.org/packages/e4/87/06a145284cbe86c91ca517fe6b57be5efbb733c0d6374b407f0992054d18/grpcio-1.69.0.tar.gz
...
%prep
%setup -q -n grpcio-1.69.0
cd %{_builddir}/grpcio-1.69.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736179795

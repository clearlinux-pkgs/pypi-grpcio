...
Source0  : https://files.pythonhosted.org/packages/91/ec/b76ff6d86bdfd1737a5ec889394b54c18b1ec3832d91041e25023fbcb67d/grpcio-1.68.1.tar.gz
...
%prep
%setup -q -n grpcio-1.68.1
cd %{_builddir}/grpcio-1.68.1
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733163937

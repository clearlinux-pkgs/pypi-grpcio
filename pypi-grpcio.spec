...
Source0  : https://files.pythonhosted.org/packages/7d/6d/919fd5886882c066122e69fbd938c1df2dc0aa22ab8de3e047c6aff5ac58/grpcio-1.60.1.tar.gz
...
%prep
%setup -q -n grpcio-1.60.1
cd %{_builddir}/grpcio-1.60.1
pushd ..
cp -a grpcio-1.60.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706825144

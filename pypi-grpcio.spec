...
Source0  : https://files.pythonhosted.org/packages/12/18/b5b5a871302d30667450f256557e1d4d07bdc273988c6932068dba60137d/grpcio-1.65.2.tar.gz
...
%prep
%setup -q -n grpcio-1.65.2
cd %{_builddir}/grpcio-1.65.2
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722442309

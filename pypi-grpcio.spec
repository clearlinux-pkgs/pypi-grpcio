...
Source0  : https://files.pythonhosted.org/packages/61/dd/d8eda79197a1275e06621850775c7bbf34a141ff92553754dde4e87d7551/grpcio-1.46.3.tar.gz
...
%prep
%setup -q -n grpcio-1.46.3
cd %{_builddir}/grpcio-1.46.3
pushd ..
cp -a grpcio-1.46.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653335470
...
cp %{_builddir}/grpcio-1.46.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-grpcio/34ac89724cb7e3fb36bcfe93efabfd012c569a0e

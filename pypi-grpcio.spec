...
Source0  : https://files.pythonhosted.org/packages/c6/45/bc828a65a3a9e66aaf347dfda12e8b126b37e3052894e0815ab3f849bc85/grpcio-1.45.0.tar.gz
...
%prep
%setup -q -n grpcio-1.45.0
cd %{_builddir}/grpcio-1.45.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648148807
...
cp %{_builddir}/grpcio-1.45.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-grpcio/34ac89724cb7e3fb36bcfe93efabfd012c569a0e

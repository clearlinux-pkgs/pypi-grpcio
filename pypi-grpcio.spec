...
Source0  : https://files.pythonhosted.org/packages/49/53/12b7979d18da23709ae93aabc5cdba1b0fb789222af48530a8cb63755a4d/grpcio-1.64.0.tar.gz
...
%prep
%setup -q -n grpcio-1.64.0
cd %{_builddir}/grpcio-1.64.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716500736

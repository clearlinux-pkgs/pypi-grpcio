...
Source0  : https://files.pythonhosted.org/packages/ab/a1/f838646e25402eb750f037cf84c1ada46084717375e44724c89900ee4c7d/grpcio-1.59.3.tar.gz
...
%prep
%setup -q -n grpcio-1.59.3
cd %{_builddir}/grpcio-1.59.3
pushd ..
cp -a grpcio-1.59.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700441055

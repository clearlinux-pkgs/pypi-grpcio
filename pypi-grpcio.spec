...
Version  : 1.49.0
Release  : 98
URL      : https://files.pythonhosted.org/packages/44/d0/789c52d384c97118b2dce430e3fcea50be85c5d0f9b6ab986865041bb2a3/grpcio-1.49.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/44/d0/789c52d384c97118b2dce430e3fcea50be85c5d0f9b6ab986865041bb2a3/grpcio-1.49.0.tar.gz
...
%prep
%setup -q -n grpcio-1.49.0
cd %{_builddir}/grpcio-1.49.0
pushd ..
cp -a grpcio-1.49.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663343004
